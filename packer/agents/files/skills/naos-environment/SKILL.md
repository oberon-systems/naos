...
- Gates are MCP servers the Run was granted. Use the tools they expose instead of opening connections yourself.
...
- A workspace from the host, when the Run has one, is mounted under `/naos/<project>`. Work there.
