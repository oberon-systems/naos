...
def report_diff(
    ...
    return tasks.transition_task(session, task_id, S.COLLECTING, S.WAITING_MERGE, lease_id=lease_id)
...
def report_merge(
    ...
    if report is not None:
        ...
        return tasks.transition_task(
            session, task_id, S.WAITING_MERGE, S.COMPLETED, lease_id=lease_id
        )
